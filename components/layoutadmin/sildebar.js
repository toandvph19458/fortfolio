  ...
  return /*html*/ `
    <div class=" bg-white rounded p-3 shadow-lg">
        <div class="flex items-center space-x-4 p-2 mb-5">
            <img class="h-12 rounded-full" src="https://certy.px-lab.com/html/demo1/assets/images/uploads/avatar/avatar-195x195.png" alt="James Bhatta">
            <div>
                <h4 class="font-semibold text-lg text-gray-700 capitalize font-poppins tracking-wide">ToanHiloo</h4>
