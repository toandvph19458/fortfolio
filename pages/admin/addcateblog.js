...
import { addcategoryBlog } from "../../api/blogCate";
...
const addcateblog = () => {
  ...
  useEffect(() => {
    ...
    form.addEventListener("submit", (e) => {
      ...
      addcategoryBlog(newCate).then((data) =>
          ...
          <div class='w-8/12 shadow-xl ml-2'>
              ...
              <h1 class="font-bold uppercase text-3xl pl-2 pt-2">Thêm Danh Mục</h1>
                  ...
                  <div class='pl-2 pt-2'>
                      ...
                      <input class="w-[200px] bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" type="text" id="cate-name">
                  </div>
